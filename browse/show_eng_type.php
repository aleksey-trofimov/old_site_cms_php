...
<style type="text/css">
body{font-family:Tahoma,Helvetica,sans-serif;color:#212676;background:#A8DCF2; padding-top: 10px;}
...
.text_verdana { FONT-SIZE: 12px; FONT-STYLE: normal; FONT-FAMILY: Helvetica; TEXT-DECORATION: none}
...
.menu_text_eng { padding-left: 5px; padding-top: 0px; padding-bottom: 0px; FONT-SIZE: 13px; COLOR: #FFFFFF; font-weight: bold;}
...
.medium_text { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 18px; COLOR: #FFFFFF; font-weight: bold;}
.tour_name { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 20px; COLOR: #ED008C; font-weight: bold;}
.tour_desc { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 14px; COLOR: #ED008C; font-weight: bold;}
.hot_tour_name { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 20px; COLOR: #293094; font-weight: bold;}
.hot_tour_desc { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 14px; COLOR: #343DBE; font-weight: bold;}
.eng_tour_name { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 20px; COLOR: #E64226; font-weight: bold; text-decoration: none; COLOR: #353292}
.eng_head { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 25px; COLOR: #E64226; font-weight: bold;}
.eng_tour_desc { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 12px; COLOR: #E64226; font-weight: bold;}
.eng_desc { padding-left: 0px; padding-top: 3px; padding-bottom: 3px; FONT-SIZE: 12px; COLOR: #E64226; font-weight: normal; COLOR: #493B92}
...
.eng_down_menu_text { padding-left: 7px; padding-top: 3px; padding-bottom: 3px; padding-right: 7px; FONT-SIZE: 12px; COLOR: #493B92; font-weight: normal;}
...
A.menu_link { COLOR: #ffffff; TEXT-DECORATION: none; FONT-SIZE: 18px;}
A { COLOR: #493B92; TEXT-DECORATION: underline}
...
<table width="850" height="500" border=0 cellpadding=0 cellspacing=0 bgcolor="#A8DCF2">
 <tr>

 <td width="260" valign="top" border="0">
<a href="http://paloma.ellink.ru">
  <img src="/common/img/eng_logo.jpg" width="260" height="72" border="0" style="display:block; margin:0;">
</a>
<!--  <img src="/common/img/tours_logo.jpg" width="260" height="84" border="0" style="display:block; margin:0;">-->
   <table width="260" height="470" border=0 cellpadding=0 cellspacing=0 bgcolor="#00ADEE">
  <tr>   
   <td width="5" border="0" background="/common/img/eng_border_left.jpg"></td>
   <td width="250" border="0" valign="top" class="menu_text_eng" style="background: url(../common/img/eng_gradient.jpg) repeat-x;">
<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=243" style="text-decoration: none;">
<font class="large_text">Welcome to Pskov!</font>
</a>
<br>&nbsp;&nbsp;&nbsp;Services for foreign visitors<br><br>

<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=245" style="text-decoration: none;"><font class="medium_text"><font class="medium_text">Ten reasons to visit Pskov </font></a>
<br>
<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=246" style="text-decoration: none;"><font class="medium_text"><font class="medium_text">Upcoming Events</font></a>
<br>

<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=230" style="text-decoration: none;"><font class="medium_text"><font class="medium_text">Paloma Tours</font></a>
<br>
<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=231" style="text-decoration: none;"><font class="medium_text">A word from our director</font></a>
<br>
...
<?php
 ...
 $variants_list = mysql_query("SELECT id, name FROM records WHERE parent_id=232 ORDER BY priority",$db)
...
//Отображаем список вариантов туров
 ...
 if( $variants_list )
 {
  while ( $variant = mysql_fetch_array($variants_list) )
  {
   ...
   echo("<a class=\"menu_link\" href=\"http://paloma.ellink.ru/browse/show_eng_type.php?var_id=$variant_id\">$variant_name</a>");
   echo("<br>");
  }
 }
...
<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=234" style="text-decoration: none;"><font class="medium_text"><font class="medium_text">Places to visit</font></a>
<div style="padding-left: 0px;">
<?php
/* $db = mysql_connect("localhost", " ", " ");
 mysql_select_db("paloma",$db);

 $variants_list = mysql_query("SELECT id, name FROM records WHERE parent_id=234 ORDER BY priority",$db)
   or die("Invalid query: " . mysql_error());
...
<a href="http://paloma.ellink.ru/browse/show_eng_type.php?var_id=247" style="text-decoration: none;"><font class="medium_text">Testimonials</font></a>
<br>



<div style="height: 10px;"><!-- --></div>
<img src="/common/img/eng_pic.jpg" /><br>
<div style="height: 10px;"><!-- --></div>
     </td>
     <td width="5" border="0" background="/common/img/eng_border_right.jpg"></td>
    </tr>
   </table>
  <img src="/common/img/eng_bottom.jpg" width="260">
<!--////////////////////////////////////////////////////////////////////////////// -->
<div style="height: 10px;"></div>

  <img class="system" src="/common/img/en_contacts_up.jpg" width="261" height="15" border="0" style="display:block; margin:0;">
   <table width="260" height="50" border=0 cellpadding=0 cellspacing=0 bgcolor="#00ADEE">
    <tr>   
     <td width="5" border="0" background="/common/img/eng_border_left.jpg"></td>
     <td width="250" border="0" valign="top" class="menu_text" bgcolor="#00ADEE">
<?php
 $db = mysql_connect("localhost", " ", " ");
 mysql_select_db("paloma",$db);


 $contacts = mysql_query("SELECT content_en FROM records WHERE id=103",$db)
   or die("Invalid query: " . mysql_error());

 $_contacts = mysql_fetch_array($contacts);
 $contacts_content = $_contacts["content_en"];
...
?>
  ...
  <img class="system" src="/common/img/en_contacts_bottom.jpg" width="260">
...
Our partners:<br><br>
<a href="http://www.childreninmoscow.ru">Children in Moscow</a>
</td>
     <td width="5" border="0" background="/common/img/eng_border_right.jpg"></td>
    </tr>
   </table>
 ...
 if($var_data_parent != 225)
 {
  ...
  if($var_parent1_parent != 225)
  {
   ...
   if($var_parent2_parent != 225)
   {
    ...
    $var_web_path = "/225/$var_parent2_parent/$var_parent1_parent/$var_data_parent/$var_id"; 
   }
   else
   {
    $var_web_path = "/225/$var_parent1_parent/$var_data_parent/$var_id"; 
   }
  }
  else
  {
   $var_web_path = "/225/$var_data_parent/$var_id"; 
  }
 }
 else
 {
  $var_web_path = "/225/$var_id";
 }
...
// echo("<font style=\"FONT-SIZE: 12px; font-weight: bold;\">$var_data_content</font>");
...
?>
  <table width="100%" border=0 cellpadding=0 cellspacing=0>
   <tr><td width="100%" border="0" class="tour_name">
        <?php echo("<a class=\"hot_tour_name\" href=\"http://paloma.ellink.ru/browse/show_eng_type.php?var_id=$var_child_id\">$var_child_name</a>");?></td></tr>
   <tr>
...
<table border=0 cellpadding=0 cellspacing=0 bgcolor="#A8DCF2">
 <tr>
  <td class="eng_down_menu_text" align="center">
